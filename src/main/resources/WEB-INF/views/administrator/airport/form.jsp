...
<acme:form>
	...
	<acme:input-select code="administrator.airport.form.label.operationalScope" path="operationalScope" choices= "${statuses}"/>
	...
	<jstl:choose>	 
		<jstl:when test="${acme:anyOf(_command, 'show|update|delete|publish') && draftMode == true}">
			...
			<acme:submit code="administrator.airport.form.button.publish" action="/administrator/airport/publish"/>
		</jstl:when>
